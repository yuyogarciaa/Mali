...
public class create_task extends AppCompatActivity {
    ...
    private void insertar() {
        ...
        String s_estatus = subject.getSelectedItem().toString();
        if(s_estatus.equals("TO DO")){ String str_status= "1".trim(); }
        else if(s_estatus.equals("IN PROGRESS")){ String str_status= "2".trim(); }
        else if(s_estatus.equals("IN REVIEW")){ String str_status= "3".trim(); }
        else if(s_estatus.equals("DONE")){ String str_status= "4".trim(); }
        else{ Toast.makeText(this,"seleccionar un campo",Toast.LENGTH_LONG).show(); }

        String s_asunto = subject.getSelectedItem().toString();
        if(s_asunto.equals("RELEASE")){ String str_asunto= "1".trim(); }
        else if(s_asunto.equals("FIX")){ String str_asunto= "2".trim(); }
        else if(s_asunto.equals("DONE")){ String str_asunto= "3".trim(); }
        else{ Toast.makeText(this,"seleccionar un campo",Toast.LENGTH_LONG).show(); }
